...
module bluemove::swap {
    ...
    public struct EscownCoins<phantom T0, phantom T1> has store, key {
        id: 0x2::object::UID,
        token_x: 0x2::balance::Balance<T0>,
        token_y: 0x2::balance::Balance<T1>,
    }
    ...
    public struct VersionManage has store, key {
        id: 0x2::object::UID,
        version: u64,
    }
    ...
    public(package) fun add_liquidity<T0, T1>(arg0: u64, arg1: u64, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<T1>, arg4: &mut Pool<T0, T1>, arg5: &mut 0x2::tx_context::TxContext) : (u64, u64, u64) {
        abort 0
    }
    ...
    public(package) fun add_liquidity_returns<T0, T1>(arg0: u64, arg1: u64, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<T1>, arg4: &mut Pool<T0, T1>, arg5: &mut 0x2::tx_context::TxContext) : (u64, u64, u64, 0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>, 0x2::coin::Coin<LSP<T0, T1>>) {
        abort 0
    }
    ...
    public(package) fun create_new_pool<T0, T1>(arg0: &mut Dex_Info, arg1: &mut 0x2::tx_context::TxContext) {
        abort 0
    }
    ...
    public(package) fun remove_liquidity<T0, T1>(arg0: u64, arg1: 0x2::coin::Coin<LSP<T0, T1>>, arg2: &mut Pool<T0, T1>, arg3: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        abort 0
    }
    ...
    public(package) fun swap_exact_x_to_y<T0, T1>(arg0: u64, arg1: 0x2::coin::Coin<T0>, arg2: address, arg3: &mut Pool<T0, T1>, arg4: &mut 0x2::tx_context::TxContext) : (u64, 0x2::coin::Coin<T1>) {
        abort 0
    }
    
    public(package) fun swap_exact_x_to_y_direct<T0, T1>(arg0: 0x2::coin::Coin<T0>, arg1: &mut Pool<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        abort 0
    }
    
    public(package) fun swap_exact_y_to_x<T0, T1>(arg0: u64, arg1: 0x2::coin::Coin<T1>, arg2: &mut Pool<T0, T1>, arg3: address, arg4: &mut 0x2::tx_context::TxContext) : (u64, 0x2::coin::Coin<T0>) {
        abort 0
    }
    
    public(package) fun swap_exact_y_to_x_direct<T0, T1>(arg0: 0x2::coin::Coin<T1>, arg1: &mut Pool<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        abort 0
    }
    
    public(package) fun swap_x_to_exact_y<T0, T1>(arg0: u64, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: address, arg4: &mut Pool<T0, T1>, arg5: &mut 0x2::tx_context::TxContext) : (u64, 0x2::coin::Coin<T1>) {
        abort 0
    }
    
    public(package) fun swap_x_to_exact_y_direct<T0, T1>(arg0: 0x2::coin::Coin<T0>, arg1: u64, arg2: &mut Pool<T0, T1>, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        abort 0
    }
    
    public(package) fun swap_y_to_exact_x<T0, T1>(arg0: u64, arg1: 0x2::coin::Coin<T1>, arg2: u64, arg3: address, arg4: &mut Pool<T0, T1>, arg5: &mut 0x2::tx_context::TxContext) : (u64, 0x2::coin::Coin<T0>) {
        abort 0
    }
    
    public(package) fun swap_y_to_exact_x_direct<T0, T1>(arg0: 0x2::coin::Coin<T1>, arg1: u64, arg2: &mut Pool<T0, T1>, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        abort 0
    }
